...
public class MainMenuScreen extends AbstractScreen {
	...
	private Button newGameButton, optionsButton, achievementsButton, exitButton;
	...
	private boolean playedNewGameButton, playedOptionsButton, playedAchievementsButton, playedExitButton;
	...
	public void render(float delta) {
		...
		super.font.draw(super.batch, "START GAME", Gdx.graphics.getWidth()/2.1694f, Gdx.graphics.getHeight()/1.44f);
		super.font.draw(super.batch, "OPTIONS", Gdx.graphics.getWidth()/2.1452f, Gdx.graphics.getHeight()/2.3225f);
		super.font.draw(super.batch, "ACHIEVEMENTS", Gdx.graphics.getWidth()/2.1452f, Gdx.graphics.getHeight()/3.323f);
